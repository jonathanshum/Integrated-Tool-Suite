model Satellite
  ...
  //parameter SI.Length xLen = 1.0, yLen = 1.5, zLen = 0.5;
  parameter SI.Length xLen = 1.5, yLen = 0.5, zLen = 1.0;
  parameter SI.Density densSat = 200.0;
  // kg/m^3
  ...
  Motor xMotor( spinAxis = {1, 0, 0} ) annotation(Placement(visible = true, transformation(origin = {16, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Motor yMotor(  spinAxis = {0, 1, 0}) annotation(Placement(visible = true, transformation(origin = {-44, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation3(r = {0, 0, -zLen / 4}) annotation(Placement(visible = true, transformation(origin = {0, -18}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Motor zMotor  annotation(Placement(visible = true, transformation(origin = {18, -42}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation2(r = {0, -yLen / 4, 0}) annotation(Placement(visible = true, transformation(origin = {-20, -16}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  SpinningPlatformTest spinningPlatformTest1 annotation(Placement(visible = true, transformation(origin = {50, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(satelliteBody.frame_a, spinningPlatformTest1.frame_a) annotation(Line(points = {{14, 0}, {12, 0}, {12, -30}, {36, -30}, {36, -30}}, color = {95, 95, 95}));
