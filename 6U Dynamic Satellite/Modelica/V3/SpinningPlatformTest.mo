model SpinningPlatformTest
  ...
  Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(Placement(visible = true, transformation(origin = {-144, -100}, extent = {{-16, -16}, {16, 16}}, rotation = 0), iconTransformation( origin = {-146, -106}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
equation
  connect(frame_a, bodyBox1.frame_a) annotation(Line(points = {{-144, - 100}, {-126, -100}}));
