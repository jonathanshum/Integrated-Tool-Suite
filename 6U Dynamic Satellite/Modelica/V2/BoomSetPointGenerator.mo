model BoomSetPointGenerator
  ...
  Modelica.Blocks.Interfaces.RealOutput psetpt1 annotation(Placement(visible = true, transformation(origin = {109, 25}, extent = {{-23, -23}, {23, 23}}, rotation = 0), iconTransformation(origin = {106, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput vsetpt1 annotation(Placement(visible = true, transformation(origin = {109, 77}, extent = {{-23, -23}, {23, 23}}, rotation = 0), iconTransformation(origin = {106, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
algorithm
