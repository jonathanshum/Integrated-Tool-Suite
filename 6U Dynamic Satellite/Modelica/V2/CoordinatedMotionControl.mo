model CoordinatedMotionControl
  ...
  Modelica.Blocks.Math.Add3 add32[1](k2 = -1, k3 = 0.0) "sadsadsa" annotation(Placement(visible = true, transformation(origin = {28, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  PID positionControl2[1](hiLim = 2, kiv = 0.0, kpv = 1.0, loLim = -2) "dsfsdsadadsa" annotation(Placement(visible = true, transformation(origin = {-14, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  BoomSetPointGenerator boomSetPointGenerator1 annotation(Placement(visible = true, transformation(origin = {-160, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0 )));
equation
  connect(boomSetPointGenerator1.psetpt1, add2.u2) annotation(Line(points = {{-149, 4}, {-74, 4}, {-74, 40}, {-64, 40}}, color = {0, 0, 127}));
  connect(boomSetPointGenerator1.psetpt2, add1.u1) annotation(Line(points = {{-150, -6}, {-80, -6}, {-80, -34}, {-64, -34} }, color = {0, 0, 127}));
  connect(boomSetPointGenerator1.vsetpt2, add31.u1) annotation(Line(points = {{-150, -3}, {-6, -3}, {-6, -32}, {16, -32}}, color = {0, 0, 127}));
  connect(boomSetPointGenerator1.vsetpt1, add32.u1) annotation(Line(points = {{-156, 10}, {-138, 10}, {-138, 96}, {2, 96}, {2, 54}, {16, 54} }, color = {0, 0, 127}));
