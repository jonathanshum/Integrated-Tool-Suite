model Satellite
  ...
  parameter SI.Length xLen = 0.7, yLen = 0.1, zLen = 0.4;
  parameter SI.Density densSat = 500.0;
  // kg/m^3
  ...
  Motor xMotor(spinAxis = {1, 0, 0}, thick = 0.03, diam = 0.08, kiv = 0.1, kpv = 0.2, bd = 0.001, delT = 0.002) annotation(Placement(visible = true, transformation(origin = {16, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  xMotor.rampRate = sat3DControlBlock1.xMotorRampRate;
  yMotor.rampRate = sat3DControlBlock1.yMotorRampRate;
  zMotor.rampRate = sat3DControlBlock1.zMotorRampRate;
  ...
  annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-06, Interval = 0.0020202));
end Satellite;